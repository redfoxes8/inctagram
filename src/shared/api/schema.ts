...
export interface paths {
  ...
  "/api/v1/payments/checkout/stripe/{providerCheckoutId}/status": {
    parameters: {
      query?: never
      header?: never
      path?: never
     ...
     * @description Returns the local state of verified webhook processing for a Stripe checkout session. This endpoint does not contact the provider API.
     */
    get: operations["getStripeCheckoutSessionStatus"]
    put?: never
    post?: never
    delete?: never
    options?: never
